...
// export const ModulePage = ({ create }: ModulePageProps) => {
...
//     {
//       onSuccess: (data) => {
//         if (!data.output) navigate(`/module/${moduleId}/create`);
//       },
//     },
//   );
...
//             <OutputSection output={data?.output} refetchOutput={refetch} moduleId={moduleId!} />
//           </Stepper.Step>
//         </Stepper>
//       )}
//       {moduleId && (
//         <CreateModuleModal
//           open={create || searchParams.get('create') === 'true'}
