...
const PRESERVED = import.meta.glob<Module>('/app/src/pages/(_app|404).{jsx,tsx}', { eager: true });
const MODALS = import.meta.glob<Pick<Module, 'default'>>('/app/src/pages/**/[+]*.{jsx,tsx}', { eager: true });
const ROUTES = import.meta.glob<Module>(['/app/src/pages/**/[\\w[-]*.{jsx,tsx}', '!**/(_app|404).*'], {
  eager: true,
});
