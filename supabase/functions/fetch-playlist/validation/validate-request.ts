...
const schema = z.object({
  playlistId: z
    .string({
      required_error: 'Missing required property: playlistId',
      invalid_type_error: 'Expected property playlistId to be of type string',
    })
    .min(1, { message: 'Property playlistId cannot be an empty string' }),
  userId: z
    .string({
